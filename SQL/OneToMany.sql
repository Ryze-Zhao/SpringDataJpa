...
INSERT INTO `t_score` VALUES (5, '语文', 99);
INSERT INTO `t_score` VALUES (6, '数学', 89);
INSERT INTO `t_score` VALUES (7, '语文', 79);
INSERT INTO `t_score` VALUES (8, '数学', 69);
...
INSERT INTO `t_student` VALUES (3, 11, '测试1');
INSERT INTO `t_student` VALUES (4, 12, '测试2');
...
CREATE TABLE `t_student_score`  (
  `t_student_id` bigint(20) NOT NULL,
  `t_score_id` bigint(20) NOT NULL,
  UNIQUE INDEX `UK_dulsbmwgi75192jsspjyf2kak`(`t_score_id`) USING BTREE,
...
INSERT INTO `t_student_score` VALUES (3, 5);
INSERT INTO `t_student_score` VALUES (3, 6);
INSERT INTO `t_student_score` VALUES (4, 7);
INSERT INTO `t_student_score` VALUES (4, 8);
